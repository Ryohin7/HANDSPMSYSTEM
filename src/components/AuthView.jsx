            ...
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-gray-100 transition-all duration-300">
                ...
                {mode === 'login' ? (
                    ...
                    <form onSubmit={handleRegister} className="space-y-5 animate-fade-in">
                        ...
                        <div className="relative"><input type="email" className="w-full border border-gray-200 rounded-2xl p-4 pl-12 outline-none focus:ring-2 focus:ring-theme/50" placeholder="電子信箱" value={registerData.email} onChange={e=>setRegisterData({...registerData, email:e.target.value})} /><Mail className="absolute left-4 top-4 text-gray-400" size={20} /></div>
